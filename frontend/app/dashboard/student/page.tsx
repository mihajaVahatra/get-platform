    ...
    <div className="mx-auto max-w-[1450px] space-y-4 text-[#111a4b]">
      <header className="flex flex-wrap items-center justify-between gap-4 pb-3">
        ...
        <div className="flex items-center gap-3">
          ...
          <button className="relative rounded-xl p-2.5 text-slate-700 transition hover:bg-violet-50">
            <Bell className="size-5" />
            <span className="absolute right-1.5 top-1.5 size-2.5 rounded-full border-2 border-white bg-rose-500" />
          </button>
          <button className="relative rounded-xl p-2.5 text-slate-700 transition hover:bg-violet-50">
