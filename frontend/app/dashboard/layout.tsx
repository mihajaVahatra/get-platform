...
function AdminGetSidebar({ pathname, onLogout }: { pathname: string; onLogout: () => void }) {
  const global = [{ label: 'Établissements', icon: Building, href: '/dashboard/admin/schools' }, { label: 'Utilisateurs', icon: UserCog, href: '/dashboard/admin/users' }, { label: 'Étudiants', icon: UsersRound, href: '/dashboard/admin?section=students' }, { label: 'Inscriptions & Admissions', icon: ClipboardList, href: '/dashboard/admin/enrollments' }, { label: 'Concours', icon: Trophy, href: '/dashboard/admin?section=competitions' }, { label: 'Programmes & Filières', icon: BookOpen, href: '/dashboard/admin?section=programs' }, { label: 'Salles & Ressources', icon: Building2, href: '/dashboard/admin?section=resources' }];
  const finances = [{ label: 'Transactions', icon: WalletCards, href: '/dashboard/admin/transactions' }, { label: 'Revenus & Rapports', icon: ChartSpline, href: '/dashboard/admin/reports' }, { label: 'Partenaires financiers', icon: Handshake, href: '/dashboard/admin?section=partners' }];
