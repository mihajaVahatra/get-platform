...
// Base UI requires `items` on Select.Root whenever the stored value differs from
// the displayed label; otherwise Select.Value renders the raw technical value.
