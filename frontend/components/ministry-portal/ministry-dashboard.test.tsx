...
vi.mock('@/components/messages/message-icon-link', () => ({
  MessageIconLink: () => null,
}));

vi.mock('@/components/messages/messages-screen', () => ({
  MessagesScreen: () => null,
}));

vi.mock('@/components/auth/MfaSettingsCard', () => ({
  MfaSettingsCard: () => null,
}));
